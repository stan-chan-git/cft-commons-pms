...
public class SinaService {
	...
	public static String  SinaStatusesUpdate(String sian_token,String status) throws IOException {

		if (sian_token != null && !sian_token.equals("")) {

			String updateUrl = SinaConstants.StatusesUpdateUrl;
			Map<String, String> upMap = new HashMap<String, String>();
			upMap.put("access_token", sian_token);
